(function (root) {
    ...
    for (funcName in arrayHackings) {
        if (typeof Array.prototype[funcName] === 'undefined') {
            Array.prototype[funcName] = arrayHackings[funcName]
        }
    }
    ...
    Yunba.prototype.subscribe = function (args, cb1, cb2) {
        ...
        //检查是否已经订阅该频道
        if (!SUB_CHANNEL_LIST.contains(channel)) {
    ...
    if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
        module.exports = Yunba;
        // 如果在 Node.JS 环境里，则需要引用 socket.io
